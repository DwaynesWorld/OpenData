namespace OpenData.Core.Tests.Query.Parsers
{
    ...
    public partial class FilterExpressionParserTests
    {
        public class ComplexExpressionTests
        {
            ...
            /// <summary>
            /// https://github.com/TrevorPilley/OpenData.Core/issues/55 - Grouped parsing error
            /// </summary>
            [Fact]
            ...
            /// <summary>
            /// https://github.com/TrevorPilley/OpenData.Core/issues/40 - Grouping doesn't support (x and y) and (a or b or c)
            /// </summary>
            [Fact]
            ...
            /// <summary>
            /// https://github.com/TrevorPilley/OpenData.Core/issues/49 - InvalidOperationException: Stack Empty thrown by FilterExpressionParser with nested grouping.
            /// </summary>
            [Fact]
            ...
            /// <summary>
            /// https://github.com/TrevorPilley/OpenData.Core/issues/36#issuecomment-70567443.
            /// </summary>
            [Fact]
